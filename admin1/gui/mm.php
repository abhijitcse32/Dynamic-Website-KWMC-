<?php
	if (isset($_POST['btnSave']))
	{
		...
		$sql="UPDATE home SET Message='$Message', HeadLine='$HeadLine', Summary='$Summary', Photo='$pic' WHERE ID=4";
...
<head>
	...
	<script>
			function deletecheck(ID)
			{
				...
				{
					window.location="?Basic=MM&Delete="+ID;
				}
			}
	</script>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> MM Message</h2>
