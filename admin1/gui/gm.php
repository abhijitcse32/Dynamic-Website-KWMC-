<?php
	if (isset($_POST['btnSave']))
	{
		...
		$sql="UPDATE home SET Message='$Message', HeadLine='$HeadLine', Summary='$Summary', Photo='$pic' WHERE ID=5";
...
<head>
	...
	<script>
			function deletecheck(ID)
			{
				...
				{
					window.location="?Basic=GM&Delete="+ID;
				}
			}
	</script>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> GM Message</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
					...
					<?php 
                            $sql="SELECT * FROM home WHERE ID=5";
