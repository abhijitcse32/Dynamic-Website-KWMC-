<?php
	if (isset($_POST['btnSave']))
	{
		...
		$sql="UPDATE contact SET HeadLine='$HeadLine', Add1='$Add1', Add2='$Add2', Phone='$Phone', Fax='$Fax', Email='$Email' WHERE ID=1";
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Dhaka Office</h2>
